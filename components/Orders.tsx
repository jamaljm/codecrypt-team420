...
export default function Dashboard() {
  ...
  const handleAccept = (callSid: string) => {
    const orderStatusRef = ref(realtime, `orders/${callSid}/status`);
  ...
  const handleCancel = (callSid: string) => {
    const orderStatusRef = ref(realtime, `calls/${callSid}/status`);
                  ...
                  <div className="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                    <div className="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                      <div className="grid grid-cols-8 gap-x-3.5">
                        ...
                        <div className="py-3.5 px-3 text-left col-span-3 text-sm whitespace-nowrap font-medium text-gray-500">
                        ...
                        <div>
                          <div className="divide-y divide-gray-200">
                            ...
                            >
                              ...
                              <div className="px-4 py-4 col-span-3 text-sm font-bold text-gray-900 whitespace-nowrap">
                                {call.location}
                              </div>
                                  ...
                                  <div className="mt-6 ring-1 ring-gray-300 rounded-2xl">
                                    <table className="min-w-full lg:divide-y lg:divide-gray-200">
                                      ...
                                      <tbody className="divide-y divide-gray-200">
                                        <tr>
                                          <td className="px-6 py-4 font-body1 text-sm font-normal text-gray-900 whitespace-nowrap">
                                            {call.order_tittle}
                                          </td>
                                          <td className="px-6 font-body1 py-4 text-sm font-normal text-gray-900 whitespace-nowrap">
                                            ₹ {call.order_price}
                                          </td>
                                          <td className="px-6 py-4 font-body1 text-sm font-normal text-gray-900 whitespace-nowrap">
                                            {call.order_quantity}
                                        ...
                                        <tr>
                                          <td className="px-6 font-body4 py-4 text-sm font-bold text-gray-900 whitespace-nowrap">
                                            Total price{" "}
                                          </td>
                              ...
                              <div className="py-12 col-span-1 bg-white sm:py-16 lg:py-2">
                                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-3">
                                  ...
                                  <div className="mt-6  rounded-2xl">
                                    ...
                                    <button
                                      onClick={() => handleCancel(call.callSid)}
